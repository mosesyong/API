...
public class EmployeeAccessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HashSet<String> employeeAccessSet = UserDao.getEmployeeAccess(employeeUsername);
            Gson gson = new GsonBuilder().setPrettyPrinting().create();
            JsonObject overall = new JsonObject();
            JsonArray accessArray = new JsonArray();
            for(String access : employeeAccessSet){
                accessArray.add(access);
            }
            overall.add("access", accessArray);
            out.println(overall); //need to add exception handling
        }
    }
