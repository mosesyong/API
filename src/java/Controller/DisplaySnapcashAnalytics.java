 ...
 * @author moses
 */
public class DisplaySnapcashAnalytics extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ArrayList<Transaction> transactionList = TransactionDao.getAllTransactions();
            ...
            for(Transaction t: transactionList){
                ...
                transactionObject.addProperty("companyName", t.companyName);
                transactionObject.addProperty("outletName", t.outletName);
                transactionObject.addProperty("id", t.transactionId);
                ...
                transactionObject.addProperty("discount", t.discountName);
